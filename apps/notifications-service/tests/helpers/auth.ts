 ...
 *
 * notifications-service guards `/v1/devices` with the shared
 * `createAuthenticateAccessToken(env.JWT_ACCESS_SECRET)` middleware, so these
 * tokens authenticate device-registration requests as-is.
 */
