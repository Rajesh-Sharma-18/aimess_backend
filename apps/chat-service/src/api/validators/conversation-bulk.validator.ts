...
export const bulkMuteConversationsSchema = z.object({
...
export const bulkMarkReadConversationsSchema = z.object({
  roomIds: roomIdsSchema,
});
...
export const bulkLeaveConversationsSchema = z.object({
  roomIds: roomIdsSchema,
  /**
