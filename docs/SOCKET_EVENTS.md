...
| ------------------- | ----------------- | -------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- |
| `message:new`       | `conv:<id>`       | `{ messageId, conversationId, senderId, contentType, contentText, contentJson, sentAt }` (+`isForwarded` on forward) | a message is created/forwarded            |
| `message:edited`    | `conv:<id>`       | `{ messageId, conversationId, contentText, contentJson, editedAt }`                                                  | message edited                            |
...
`message:forward` · `messages:fetch` · `typing:start` · `typing:stop` ·
...
**Server → Client:** `message:new` · `message:edited` · `message:read` ·
